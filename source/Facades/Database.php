 ...
 * @method static Statement query(string $sql, $bindings = null, array $driverOptions = [])
 * @method static ?array                              update(string $table, object | array $data, string $condition, $bindings = null)
 * @method static Statement read(string $table, ?string $condition = null, $bindings = null)
